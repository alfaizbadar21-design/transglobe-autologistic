...
export default function ListingCard({ listing }: { listing: Listing }) {
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-2xl bg-card border border-[hsl(38_16%_22%)] shadow-luxe shadow-luxe-hover">
      {/* Image */}
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="mt-4 flex items-center justify-between pt-4 border-t border-[hsl(38_16%_18%)]">
          ...
          <Link
            href={`/intake-hub?listing=${listing.id}`}
            className="inline-flex items-center gap-1 text-[12px] font-medium text-foreground/85 hover:text-foreground transition-colors"
          >
            Request
